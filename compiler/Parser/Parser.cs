...
/// <summary>
/// Выполняет синтаксический разбор программы на языке МЯУ#. /// Грамматика программы описана в top-level-grammar.
/// </summary>
public class Parser(Context context, IEnvironment environment, string code)
{
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет программу с использованием переданных контекста и окружения.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет синтаксический разбор главной функции.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор объявления функции.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор списка параметров.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор типа возврата.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор типа.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор общей инструкции.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор объявления переменной.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор объявления константы.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор присваивания.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции ввода.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции вывода.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции if.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции return.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор инструкции вызова функции.
...
/*    if (!context.IsFunction(functionName))
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения логического или.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения логического и.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения сравнения.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения сложения/вычитания.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения умножения/деления/остатка от деления.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения унарного оператора.
    /// unary = [ "!" ], [ "+" | "-" ], power.
    /// Выполняет синтаксический разбор выражения унарного оператора.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения возведения в степень.
    /// power = primary, [ "^", unary ].
    /// Выполняет синтаксический разбор выражения возведения в степень.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения первичного оператора.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения литерала.
    /// </summary>
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения булевого значения.
    ...
    /// <summary>
    /// Выполняет синтаксический разбор выражения константы.
    /// constant = "пи" | "эклер".
    /// </summary>
