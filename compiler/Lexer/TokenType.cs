...
public enum TokenType
{
    ...
    /// <summary>
    ///  Ключевое слово "мурлыкать" - пользовательский вывод.
    /// </summary>
    Output,

    /// <summary>
    ///  Ключевое слово "клацать" - пользовательский ввод.
    /// </summary>
    Input,
    ...
    /// <summary>
    /// Ключевое слово "ничего" - тип возврата void.
    /// </summary>
    Void,

    /// <summary>
    /// Ключевое слово "хотябыраз" - цикл do-while.
    /// </summary>
    DoWhile,

    /// <summary>
    /// Ключевое слово "хвостомкрутить" - цикл for.
    /// </summary>
    For,

    /// <summary>
    /// Ключевое слово "стоп" - прерывание цикла.
    /// </summary>
    Break,

    /// <summary>
    /// Двоеточие ':' - используется для указания типа возврата функции.
    /// </summary>
    Colon,
}
